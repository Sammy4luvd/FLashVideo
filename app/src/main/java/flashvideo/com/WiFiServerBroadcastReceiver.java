...
/**
 * Created by Dalafiari Samuel on 11/27/2016.
 */
public class WiFiServerBroadcastReceiver extends BroadcastReceiver {
    ...
    public WiFiServerBroadcastReceiver(WifiP2pManager manager, Channel channel, SendActivity activity) {
        ...
        activity.setServerStatus("Sever for p2p created!");
